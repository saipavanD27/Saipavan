...
//	}
	...
	public Devices samsung() {
		...
		ModelAndView mv=new ModelAndView("/samsung");
		Device d1=new Device(1, "Galaxy Samsung23", "Smart phone--from1");
		Device d2=new Device(2, "Galaxy Samsung24", "Smart phone--from1");
		Device d3=new Device(3, "Galaxy Samsung25", "Smart phone--from1");
		Device d4=new Device(4, "Galaxy Samsung23Ultra", "bad choice Smart phone--from1");
		ArrayList<Device> myList = new ArrayList();
		myList.add(d1);
		myList.add(d2);
		myList.add(d3);
